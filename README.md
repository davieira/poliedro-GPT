...
|---------|---------------|-------|
| **Claude** (web/app) | Custom Connector → `https://poliedro-api.iden.is/mcp` | Automático (DCR) — só login P+ |
...
**Publicar o GPT:** use `https://poliedro-api.iden.is/privacy` como Privacy policy URL.
...
4. **Connector URL:** `https://poliedro-api.iden.is/mcp`
