...
3. Cole a **Connector URL**: `https://poliedro-api.iden.is/mcp`
...
- Confirme que a API responde: `curl https://poliedro-api.iden.is/health`
- Metadados MCP: `curl https://poliedro-api.iden.is/.well-known/oauth-protected-resource/mcp`
